  ...
  state = {
    ...
    ejeydos:'',
		fechas: [
			{
        fecha: '26/08/2019',
        xaxis: '26 agosto de 2019',
        y1axis: 3,
        y2axis: 18,
			},{
        fecha: '27/08/2019',
        xaxis: '27 agosto de 2019',
        y1axis: 4,
        y2axis: 29,
			},{
        fecha: '28/08/2019',
        xaxis: '28 agosto de 2019',
        y1axis: 5,
        y2axis: 30,
			}
		]
    ...
    return (
      <div className="App">
        ...
        <div className="form-group row">
          ...
          <div class="card text-center border-secondary mb-3">
            ...
            <div className="form-group row">
              <div className="form-group col-md-2">
                <label className="font-weight-bold" htmlFor="">FECHA</label>
              </div>
          ...
          <div className="col-md-3" key="1">
          <div class="card text-center border-secondary mb-3">
              <div className="card-header bg-transparent border-secondary">FECHAS</div>
        ...
        <BarChart
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="y1axisY" fill="#8884d8" />
